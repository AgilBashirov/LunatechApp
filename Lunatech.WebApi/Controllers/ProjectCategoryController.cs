...
namespace Lunatech.WebApi.Controllers
{
    ...
    {
        private readonly IRepositoryService<ProjectCategory> _projectCategoryService;
        private readonly IMapper _mapper;
        public ProjectCategoryController(IRepositoryService<ProjectCategory> projectCategoryService, IMapper mapper)
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Domain.Entities.ProjectCategory>> Get(int id, int langId)
        {
        ...
        [HttpGet]
        public async Task<ActionResult<List<Domain.Entities.ProjectCategory>>> Get(int langId)
        {
        ...
        {
            var result = _mapper.Map<Domain.Entities.ProjectCategory>(command);
